...
IMAGE_ROOT = PROJECT_ROOT / "frontend" / "images"
input_path = IMAGE_ROOT / "logo.jpeg"
output_png = IMAGE_ROOT / "logo.png"
output_png_white = IMAGE_ROOT / "logo-white.png"  # versão pra usar em fundo escuro
...
for size_name, size_px in [('small', 80), ('medium', 200), ('large', 500)]:
    ...
    out_path = IMAGE_ROOT / f'logo-{size_name}.png'
